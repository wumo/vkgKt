...
import com.github.wumo.vkg.graphics.model.Camera
import com.github.wumo.vkg.graphics.Input
import com.github.wumo.vkg.graphics.VkgNative
import com.github.wumo.vkg.graphics.VkgNative.DeletePanningCamera
import com.github.wumo.vkg.graphics.VkgNative.PanningCameraUpdate

class PanningCamera(val camera: Camera): AutoCloseable {
  private val native =
    VkgNative.NewPanningCamera(camera.native.notNull())
  
  fun update(input: Input) {
    PanningCameraUpdate(native.notNull(), input.native.notNull())
  }
  
  override fun close() {
    DeletePanningCamera(native.notNull())
  }
