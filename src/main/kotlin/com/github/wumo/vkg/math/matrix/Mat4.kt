...
class Mat4 constructor(raw: FloatArray, offset: Int = 0) : Mat<Mat4, Vec4>(raw, 4, offset) {
  ...
  constructor(m: Mat3) : this(
    m.raw[m.offset + 0], m.raw[m.offset + 1], m.raw[m.offset + 2], 0f,
    m.raw[m.offset + 3], m.raw[m.offset + 4], m.raw[m.offset + 5], 0f,
    m.raw[m.offset + 6], m.raw[m.offset + 7], m.raw[m.offset + 8], 0f,
    0f, 0f, 0f, 0f,
  )
